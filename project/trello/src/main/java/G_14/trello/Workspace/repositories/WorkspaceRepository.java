...
//    @Query(value="select workspace.workspace_name from workspace where workspace.id=?1",nativeQuery = true)
//    String workspaceNameById(Integer workspace_id);
//    @Query(value="select * from workspace where workspace.id=?1",nativeQuery = true)
//    Workspace workspaceModelById(Integer workspace_id);
